...
test("Test interpreter on interpreter_stmt01 program") {
...
test("Test interpreter on interpreter_factorial program: factorial(5)") {
...
test("Test interpreter on interpreter_factorial program: factorial(1)") {
...
test("Test interpreter on interpreter_factorial program: factorial(0)") {
