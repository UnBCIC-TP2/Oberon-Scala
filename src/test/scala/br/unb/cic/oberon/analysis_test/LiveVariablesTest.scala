...
class LiveVariablesTest extends AnyFunSuite {
	...
	// 	var graph_expected: GraphStructure = Graph()
	...
	// 	var hash_map_expected: HashMapStructure = HashMap()

	// 	hash_map_expected = hash_map_expected + (StartNode() 		-> (SetStructure, SetStructure))
	// 	hash_map_expected = hash_map_expected + (SimpleNode(s1) 	-> (SetStructure, SetStructure))
	// 	hash_map_expected = hash_map_expected + (SimpleNode(s2) 	-> (SetStructure, SetStructure))
	// 	hash_map_expected = hash_map_expected + (SimpleNode(s3) 	-> (SetStructure, SetStructure))
	// 	hash_map_expected = hash_map_expected + (SimpleNode(s3_1) 	-> (SetStructure, SetStructure))
	// 	hash_map_expected = hash_map_expected + (SimpleNode(s4) 	-> (SetStructure, SetStructure))
	// 	hash_map_expected = hash_map_expected + (EndNode() 			-> (SetStructure, SetStructure))
	...
	// 	var live_variables_expected: HashMapStructure = HashMap()

	// 	live_variables_expected = live_variables_expected + (StartNode() 		-> (Set(), Set()))
	// 	live_variables_expected = live_variables_expected + (SimpleNode(s1) 	-> (Set(), Set["x"]))
	// 	live_variables_expected = live_variables_expected + (SimpleNode(s2) 	-> (Set["x"], Set["max", "x"]))
	// 	live_variables_expected = live_variables_expected + (SimpleNode(s3) 	-> (Set["max", "x"], Set["max", "x"]))
	// 	live_variables_expected = live_variables_expected + (SimpleNode(s3_1) 	-> (Set["x"], Set["max"]))
	// 	live_variables_expected = live_variables_expected + (SimpleNode(s4) 	-> (Set["max"], Set()))
	// 	live_variables_expected = live_variables_expected + (EndNode() 			-> (Set(), Set()))
