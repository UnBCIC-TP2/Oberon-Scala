  ...
  def generateStatement(stmt: Statement, insts: List[TAC]): List[TAC] = {
    try {
      stmt match {
        ...
        case _ =>
          throw new UnsupportedOperationException(s"Declaração não suportada: $stmt")
      }
    } catch {
      case e: UnsupportedOperationException =>
        throw new UnsupportedOperationException(s"Erro ao gerar código para a declaração: $stmt", e)
      case e: Exception =>
        throw new RuntimeException(s"Erro inesperado ao gerar código para a declaração: $stmt", e)
    }
  }
  ...
  def generateExpression(
    ...
    try {
      expr match {
        ...
        case _ =>
          throw new UnsupportedOperationException(s"Expressão não suportada: $expr")
      }
    } catch {
      case e: UnsupportedOperationException =>
        throw new UnsupportedOperationException(s"Erro ao gerar código para a expressão: $expr", e)
      case e: Exception =>
        throw new RuntimeException(s"Erro inesperado ao gerar código para a expressão: $expr", e)
    }
  }
